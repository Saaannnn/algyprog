...
def generar_matrices_user(filas,columnas):
    matriz = [] #La matriz tiene que estar vacía de esta forma)
...
def siguiente_generacion(matriz): #Aplica las reglas y devuelve la nueva matriz
...
def main():
    filas = int(input('Ingrese el numero de filas : ')) #Aún no le puesto límite
    columnas = int(input("Ingrese el numero de columnas:"))
    m1 = generar_matrices_user(filas,columnas) #Matriz principal
