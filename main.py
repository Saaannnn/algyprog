...
def menu_principal():
    ...
    while True:
        limpiar_pantalla()
        print(Fore.LIGHTWHITE_EX+"╔════════════════════════════════════════════════════════════════╗")
        print(Fore.LIGHTWHITE_EX+"║               PROYECTO ALGORITMOS Y PROGRAMACION               ║")
        print(Fore.LIGHTWHITE_EX+"║                    AUTOMATA CELULAR ALIVE                      ║")
        print(Fore.LIGHTWHITE_EX+"║        Realizado por: Jesus, Diego, Alessandro y Eleam         ║")
        print(Fore.LIGHTWHITE_EX+"╚════════════════════════════════════════════════════════════════╝\n\n")

        print(Fore.LIGHTCYAN_EX+"┌─────────────── MENÚ PRINCIPAL ────────────────────────────────┐")
